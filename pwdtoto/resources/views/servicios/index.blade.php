...
<body>
    @section('content')
    <div class=" bg-indigo-600 bg-opacity-50 p-4 ">
        <!-- Contenido de la zona azul -->
        
        <!-- ESPACIO 1*3 -->
        <div class="grid grid-cols-3 gap-4 ">
            <!-- Cuadro -->
            <div class=" bg-slate-600 p-4 shadow-md ">
                <!-- Contenido de la tarjeta 1 -->
                <div class="max-w-sm mx-auto bg-dark border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ">
                    <a href="#">
                        <img class="rounded-t-lg" src="/docs/images/blog/image-1.jpg" alt="" />
                    </a>
                    <div class="p-5">
                        <a href="#">
                            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">SerVicio !</h5>
                        </a>
                        <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">este servicio .... trata de de ....... 
                            ,,,,, 
                            ,,,,,
                            ,,,,,
                            ,,,,,
            ...
            <div class=" bg-slate-600 p-4 shadow-md">
                ...
                <div class="w-full max-w-sm mx-auto bg-black border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="flex flex-col items-center pb-10">
                        <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="https://pps.whatsapp.net/v/t61.24694-24/328768676_524271279636024_8574569258804315784_n.jpg?ccb=11-4&oh=01_AdRIfRUIhFjziMD50kDp677yuy5WfsboQYqdA4nElE_Giw&oe=648138E6" alt="Bonnie image"/>
                        <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">Alfredo Flores</h5>
                        <span class="text-sm text-gray-500 dark:text-gray-400">Ingeniero</span>
                        <div class="flex mt-4 space-x-3 md:mt-6">
                            <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Contacto</a>
                            <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-gray-900 bg-dark border border-gray-300 rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-700 dark:focus:ring-gray-700">Message</a>
                        </div>
                    </div>
                </div>
                <!-- Contenido de la tarjeta 2 -->
...
<div class=" bg-amber-500 max-w-sm rounded overflow-hidden shadow-lg">
  <img class="w-full" src="https://v1.tailwindcss.com/img/card-top.jpg" alt="Sunset in the mountains">
  <div class="px-6 py-4">
    <div class="font-bold text-xl mb-2 text-slate-950">
        The Coldest Sunset
    </div>
  ...
  <div class="px-6 pt-4 pb-2">
    ...
    <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700 mr-2 mb-2">#winter</span>
            ...
            <div class=" bg-slate-600 p-4 shadow-md">
                ...
                <div class="w-full max-w-sm mx-auto p-4  bg-red-900 border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
                    <h5 class="mb-3 text-base font-semibold text-gray-900 md:text-xl dark:text-white">
                        Lsta De Servicios
                    </h5>
                    <p class="text-sm font-normal text-gray-500 dark:text-gray-400">Servicios serviciosos</p>
                    <ul class="my-4 space-y-3">
                        <li>
                            <a href="{{ route('show') }}" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                        ...
                        <li>
                            <a href="{{ route('create') }}" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                        ...
                        <li>
                            <a href="{{ route('index') }}" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap">index</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap">Servicios 4</span>
                            </a>
                        </li>
                        <li>
                            <a href="#" class="flex items-center p-3 text-base font-bold text-gray-900 rounded-lg bg-gray-50 hover:bg-gray-100 group hover:shadow dark:bg-gray-600 dark:hover:bg-gray-500 dark:text-white">
                                ...
                                <span class="flex-1 ml-3 whitespace-nowrap">Servicios 5</span>
                            </a>
                        </li>   
                    </ul>
                    <div>
                        <a href="#" class="inline-flex items-center text-xs font-normal text-gray-500 hover:underline dark:text-gray-400">
                            ...
                            Que clase de servicio servicioso deseas?</a>
                    </div>
                </div>                                          
                <!-- Contenido de la tarjeta 5 -->
            </div>
        ...
        <div class="grid grid-cols-1 gap-4 mt-4">
            ...
            <div class=" bg-slate-600 p-4 shadow-md">
                ...
                <div class="grid mb-8 border border-blak rounded-lg shadow-sm dark:border-gray-700 md:mb-12 md:grid-cols-2">
                    <figure class="flex flex-col items-center justify-center p-8 text-center bg-dark border-b border-gray-200 rounded-t-lg md:rounded-t-none md:rounded-tl-lg md:border-r dark:bg-gray-800 dark:border-gray-700">
                        <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</h3>
                            <p class="my-4">xxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</p>
                        </blockquote>
                        <figcaption class="flex items-center justify-center space-x-3">
                            <img class="rounded-full w-9 h-9" src="https://flowbite.s3.amazonaws.com/blocks/marketing-ui/avatars/karen-nelson.png" alt="profile picture">
                            <div class="space-y-0.5 font-medium dark:text-white text-left">
                                <div>xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</div>
                                <div class="text-sm text-gray-500 dark:text-gray-400">xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</div>
                            </div>
                        </figcaption>    
                    </figure>
                    <figure class="flex flex-col items-center justify-center p-8 text-center bg-succes border-b border-gray-200 rounded-tr-lg dark:bg-gray-800 dark:border-gray-700">
                        <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</h3>
                            <p class="my-4">xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</p>
                        </blockquote>
                        <figcaption class="flex items-center justify-center space-x-3">
                    ...
                    <figure class="flex flex-col items-center justify-center p-8 text-center bg-danger border-b border-gray-200 rounded-bl-lg md:border-b-0 md:border-r dark:bg-gray-800 dark:border-gray-700">
                        <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</h3>
                            <p class="my-4">xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</p>
                        </blockquote>
                        <figcaption class="flex items-center justify-center space-x-3">
                            ...
                            <div class="space-y-0.5 font-medium dark:text-white text-left">
                                ...
                                <div class="text-sm text-gray-500 dark:text-gray-400">xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</div>
                            </div>
                        </figcaption>    
                    </figure>
                    <figure class="flex flex-col items-center justify-center p-8 text-center bg-warning border-gray-200 rounded-b-lg md:rounded-br-lg dark:bg-gray-800 dark:border-gray-700">
                        <blockquote class="max-w-2xl mx-auto mb-4 text-gray-500 lg:mb-8 dark:text-gray-400">
                            <h3 class="text-lg font-semibold text-gray-900 dark:text-white">xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</h3>
                            <p class="my-4">xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx</p>
                        </blockquote>
                        <figcaption class="flex items-center justify-center space-x-3">
