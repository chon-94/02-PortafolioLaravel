    ...
    <div class="bg-blue-500 bg-opacity-50 p-4">
        ...
        <div class="grid grid-cols-3 gap-4">
            ...
            <div class="bg-white p-4 shadow-md">
                ...
                <div class="max-w-sm bg-dark border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
            ...
            <div class="bg-white p-4 shadow-md">
                ...
                <div class="w-full max-w-sm bg-yellow-600 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
        ...
        <div class="grid grid-cols-2 gap-4 mt-4">
            ...
            <div class="bg-white p-4 shadow-md">
                ...
                <div class="w-full p-4 text-center bg-black border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="bg-white p-4 shadow-md">
                ...
                <div class="w-full max-w-sm p-4  bg-red-900 border border-gray-200 rounded-lg shadow sm:p-6 dark:bg-gray-800 dark:border-gray-700">
